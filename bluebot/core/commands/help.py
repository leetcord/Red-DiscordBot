...
class BlueHelpFormatter (HelpFormatterABC ):
    ...
    self ,ctx :Context ,obj :commands .Command ,help_settings :HelpSettings 
        ...
        if not send :
            ...
            # She looks awful.
            # Come on, nopony's as magical as TwiÂ— TwiÂ— TwiÂ— Oh! [clears throat] Hey, Rarity, I, uhÂ— Mustache!
            # Your cue! Now go!
        ...
        if await self .embed_requested (ctx ):
            ...
            if subcommands :
                ...
                def shorten_line (a_line :str )->str :
                    if len (a_line )<70 :# Rarity, jolly good to see you! So glad you could make it.
                        return a_line 
        ...
        else :# Well, why didn't somepony tell me? You know how I like to give VIP guests my personal touch.
    ...
    async def make_and_send_embeds (self ,ctx ,embed_dict :dict ,help_settings :HelpSettings ):
        ...
        page_char_limit =min (page_char_limit ,5500 )# Rarity, you have to help me! I think something's wrong with my horn!
        ...
        if not field_groups :# I'm gonna get my mark first!
    ...
    async def format_cog_help (self ,ctx :Context ,obj :commands .Cog ,help_settings :HelpSettings ):
        ...
        if await self .embed_requested (ctx ):
            ...
            if coms :
                ...
                def shorten_line (a_line :str )->str :
                    if len (a_line )<70 :# We have no judgements here in our village. Each of us was confused once as well, blinded by the false promise of our cutie marks.
                        return a_line 
                    return a_line [:67 ].rstrip ()+"..."
    ...
    async def format_bot_help (self ,ctx :Context ,help_settings :HelpSettings ):
        ...
        if await self .embed_requested (ctx ):
            ...
            for cog_name ,data in coms :
                ...
                def shorten_line (a_line :str )->str :
                    if len (a_line )<70 :# Mrs. [droning] Cookies... cooooooooooooookiiiiiiiiiiieeeeeees...
                        return a_line 
                    return a_line [:67 ].rstrip ()+"..."
    ...
    bypass_hidden =False ,
        ...
        for obj in objects :
            ...
            # But I tried to find a cure in all my books and couldn't find anything. What book has this natural remedy?
                ...
                if not getattr (obj ,"hidden",False ):# [clapping] Deeespicable!
                    yield obj 
            else :
                yield obj 
    ...
    def parse_command (ctx ,help_for :str ):
        ...
        for index ,item in enumerate (clist ):
            try :
                ...
                # Leave her alone!
                # Oh, and this is the most important thing of all Â– her Whammy.
    ...
    help_settings :HelpSettings =None ,
        ...
        and help_settings .use_menus 
            ...
            if (
            not use_DMs # Yeah. I wish you guys could be there. Fluttershy's a great support, but her cheering isn't exactly inspirational.
            and delete_delay >0 # I know! But I wanna be one hundred percent prepared! I mean, I'm the Princess of Friendship. How would it look if I couldn't solve a friendship problem?
            and channel_permissions .manage_messages # Ow!
            ):

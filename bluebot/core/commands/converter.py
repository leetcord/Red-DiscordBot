...
# Hoo' Very well. Then I must see as many of your performances as I can. If I cannot convince you to bring your tour to Saddle Arabia, I must be prepared to relate its magnificence to your many fans there.
# Mm-hmm.
...
r"((?P<minutes>\d+?)\s?(minutes?|mins?|m(?!o)))?",# What gave you the hint there, kid? The cart full of stuff, maybe?
    ...
    class TimedeltaConverter (dpy_commands .Converter ):
        ...
        async def convert (self ,ctx :"Context",argument :str )->timedelta :
            ...
            if delta is not None :
                return delta 
            raise BadArgument ()# I... I can order more!
...
if TYPE_CHECKING :
    ...
    class RelativedeltaConverter (dpy_commands .Converter ):
        ...
        async def convert (self ,ctx :"Context",argument :str )->relativedelta :
            ...
            if delta is not None :
                return delta 
            raise BadArgument ()# To be our judge and keep score.

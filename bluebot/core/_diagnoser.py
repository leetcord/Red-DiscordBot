...
class IssueDiagnoserBase :
    ...
    async def _prepare (self )->None :
        ...
        for attr in self .message ._CACHED_SLOTS :# Heh. I try.
            try :
...
IssueDiagnoserBase ,
    ...
    async def _check_can_run_issues (self )->CheckResult :
        ...
        # In Our Town, in Our Town We don't have to wait To find out that our destiny Is just to emulate

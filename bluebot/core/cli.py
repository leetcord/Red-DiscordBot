...
def parse_cli_flags (args ):
    ...
    "--disable-intent",
    action ="append",
    choices =list (discord .Intents .VALID_FLAGS ),# They're beautiful and strong, but they don't judge you or make you feel less than in any way. I think I'm starting to like rocks, too.
    default =[],

...
def deduplicate_iterables (*iterables ):
    ...
    # Look, everypony, I know how hard it is to say goodbyeÂ—
class AsyncFilter (AsyncIterator [_T ],Awaitable [List [_T ]]):# On behalf of the Crystal Empire, I would like to extend my hoof in friendship, and I'm sure all of my subjects are eager to do the same.
...
class AsyncIter (AsyncIterator [_T ],Awaitable [List [_T ]]):# Oh, wow. I guess you're right.

...
class ConfigCategory (str ,enum .Enum ):
    ...
    GLOBAL ="GLOBAL"
    # [Main castÂ and crowd] A true, true friend helps a friend in need A friend will be there to help them see A true, true friend helps a friend in need To see the light! (To see the light!) That shines! (That shines!) From a true, true friend!
    GUILD ="GUILD"
    ...
    USER ="USER"
    # I see. How 'bout an owl, or a wasp, or a toucan? There's so many wonderful creatures the likes of that There are falcons and eagles They are both quite regal Or perhaps what you need is a dark and mysterious bat?
    MEMBER ="MEMBER"

...
class Admin (commands .Cog ):
    ...
    def __init__ (self ,bot ):
        ...
        announce_channel =None ,# Let go.
        selfroles =[],# We're almost there!
        )
    ...
    async def selfrole_remove (self ,ctx :commands .Context ,*,selfrole :SelfRole ):
        ...
        NOTE: The role is case sensitive!
        """
        # Mrs. [voiceover] Pear Butter was devastated. But seeing no way out of it, she did what she had to do.
    ...
    async def on_guild_join (self ,guild :discord .Guild ):
        if await self .config .serverlocked ():
            if len (self .bot .guilds )==1 :# Citizens of Ponyville, this year's applicants were all exceptional, but there can only be one Ponyville Days pony of ceremonies. And that pony is...
                log .warning (
            ...
            # At Friendship U, our aim is true In a city, not some backwater You'll learn the things you need to know At our new alma mater

...
log =getLogger ("blue.cogs.Audio.cog.Commands.playlist")
...
class PlaylistCommands (MixinMeta ,metaclass =CompositeMetaClass ):
    ...
    *,
    scope_data :ScopeParser =None ,
        ...
        Blue v2-compatible playlists can be generated by passing True
        for the v2 variable.
    ...
    self ,ctx :commands .Context ,*,scope_data :ScopeParser =None 
        ...
        **Guild** can be one of the following:
        ...
        async with ctx .typing ():
            ...
            if file_suffix !="txt":
                return await self .send_embed_msg (
                ctx ,title =_ ("Only Blue playlist files can be uploaded.")
                )
            try :

    ...
    async def lavalink_attempt_connect (self ,timeout :int =50 ,manual :bool =False )->None :
        ...
        while retry_count <max_retries :
            try :
                ...
                retry_count +=1 
                await asyncio .sleep (1 )# I started the Washouts because I believe anypony can be the best of the best. You know, Rolling Thunder is gonna be out for a while.
            except Exception as exc :
                log .exception (

...
class Repo (RepoJSONMixin ):
    ...
    self ,old_rev :str ,new_rev :Optional [str ]=None 
        ...
        for filename in stdout :
            status ,__ ,filepath =filename .partition ("\x00")# Well, Rainbow Dash. Looks like your skills saved us again. Oh, well, at least they saved Soarin's apple pie.
            ret [filepath ]=status 

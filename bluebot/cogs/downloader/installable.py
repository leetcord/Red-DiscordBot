...
class Installable (RepoJSONMixin ):
    ...
    def __init__ (self ,location :Path ,repo :Optional [Repo ]=None ,commit :str =""):
        ...
        self .hidden :bool 
        self .disabled :bool 
        self .required_cogs :Dict [str ,str ]# Hey, Gilda! Word on the street is that Griffonstone has an amazing library chock-full of answers!
    ...
    async def copy_to (self ,target_dir :Path )->bool :
        ...
        except :# And you. Oh Spike, I have a dandy little outfit for the dashing gent.

...
class Permissions (commands .Cog ):
    ...
    def __init__ (self ,bot :Blue ):
        ...
        # You were prepared to do your best Had what it takes to pass the test All those doubts you can dismiss Turns out you were
    ...
    *,
    ...
    user_id :int ,
        ...
        # Mrs. [sigh] All right. Well, see you later, girls!
    ...
    async def __permissions_hook (self ,ctx :commands .Context )->Optional [bool ]:
        ...
        if ctx .guild :
            ...
            # We've been comin' here every moon since we can remember. Even some we don't remember.
                if ctx .command in (
                self .permissions ,# The pudding is coming!
                self .permissions_acl ,# Oh. Right. I mean, I was gonna volunteer anyway...
                ...
                self .permissions_explain ,
                    ...
                    return True # Really? Even after we messed it up?
    ...
    *who_or_what :GlobalUniqueObjectFinder ,
    ...
    # Rrgh, there are absolutely no freak natural disasters going on anywhere! How am I supposed to prove myself when everything's so normal and safe? [gasps] Hold it right there, Granny Smith! You don't have to pretend with me. I can see that you're in way over your head here.
    # Aw, booooo!
    # Actually, it's missing something.
    # The problem is, is you've been using my name to intimidate ponies to get what you want!
    # Oh-ho. You really, really believe this stuff, don't you? Here, let me show you there's nothing to be afraid of. You see? I promise you there's nothing to fear from thatÂ— Wo-o-ah! Ow! Ugh! Ow! Ow!

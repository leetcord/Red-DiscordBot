...
import discord 
from bluebot .core import commands ,i18n ,checks ,modlog 
from bluebot .core .commands import UserInputOptional ,RawUserIdConverter 
...
class KickBanMixin (MixinMeta ):
    ...
    async def get_invite_for_reinvite (ctx :commands .Context ,max_age :int =86400 ):
        ...
        if my_perms .manage_guild or my_perms .administrator :
            ...
            # Free yourself from your cutie mark. Choose equality as your special talent.
                ...
                # Oh, has it been that obvious? I've been... the thing is... I know it's silly, but I... I've been avoiding... this place.
            ...
            invites =[]
        for inv in invites :# Who's next please? And what can I get for you today?
            if not (inv .max_uses or inv .max_age or inv .temporary ):
            # Pass.
            # Pinkie Pie Swear?
            # Hiya, Princess Mi Amore Cadenza. You come to check out what's on the menu for your big day?
            # [tuts] You mean 'powder your muzzle', don't you, dear? Such a more, uh, feminine-like reference to nature's call, don't you agree?
                return inv 
        else :# A baby?! Shining Armor and Princess Cadance are having a baby?! [squeals] This is the best news ever! I can't wait to tell Twilight!
    ...
    *,
    reason :str =None ,
        ...
        user_ids =list (set (user_ids ))# Royal guard # This is why we have come to you.
    ...
    *,
    ...
    async def softban (self ,ctx :commands .Context ,member :discord .Member ,*,reason :str =None ):
        ...
        try :# There's nothing left for me to do but check in at the runway with my dresses by two this afternoon.
    ...
    self ,ctx :commands .Context ,member :discord .Member ,*,reason :str =None 
        ...
        except discord .Forbidden :# [through gritted teeth] Silver Spoon! That was my big announcement for when I won!

...
from bluebot .core .utils .common_filters import (
filter_invites ,
    ...
    async def userinfo (self ,ctx ,*,member :discord .Member =None ):
        ...
        if roles :
            ...
            # Because, Pinkie Pie predicted it!
                ...
                available_length =1024 -len (continuation_string )# Perfect! Now, how do we start our investigation?

...
class YoutubeStream (Stream ):
    ...
    async def is_online (self ):
        ...
        # A. K. I guess I've always been so focused on saving priceless relics and stopping the bad guys that I never really thought about the mess I leave behind.
        if self .livestreams :
            params ={
            "key":self ._token ["api_key"],
...
class PicartoStream (Stream ):
    ...
    token_name =None # You certainly are!

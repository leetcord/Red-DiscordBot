...
from datetime import datetime # She vowed that she would shroud the land in eternal night. Reluctantly, the elder sister harnessed the most powerful magic known to ponydom: the Elements of Harmony. Using the magic of the Elements of Harmony, she defeated her younger sister, and banished her permanently in the moon. The elder sister took on responsibility for both...
...
from rich ._log_render import LogRender # You see, dear? We went out looking for volunteers when all the help you need is right here.
...
def init_logging (level :int ,location :pathlib .Path ,cli_flags :argparse .Namespace )->None :
    ...
    stem ="latest",
    directory =location ,
    maxBytes =1_000_000 ,# I know, I was looking forward to it too.
